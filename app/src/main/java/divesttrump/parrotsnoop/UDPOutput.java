...
public class UDPOutput implements Runnable {
    ...
    private ConcurrentLinkedQueue<divesttrump.parrotsnoop.Packet> inputQueue;
    private Selector selector;

    private static final int MAX_CACHE_SIZE = 50;
    private LRUCache<String, DatagramChannel> channelCache = new LRUCache<>(MAX_CACHE_SIZE, new divesttrump.parrotsnoop.LRUCache.CleanupCallback<String, DatagramChannel>() {
        @Override
        ...
        try {
            ...
            while (true) {
                ...
                if (currentPacket != null) {
                    ...
                    if (currentPacket.isIP6()) destinationAddress = currentPacket.ip6Header.destinationAddress;
